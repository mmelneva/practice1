...
require_once dirname(dirname(__FILE__)) . '/vendor/simpletest/simpletest/unit_tester.php';
require_once dirname(dirname(__FILE__)) . '/vendor/simpletest/simpletest/reporter.php';
